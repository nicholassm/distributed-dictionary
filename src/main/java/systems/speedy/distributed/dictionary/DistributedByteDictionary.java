...
public interface DistributedByteDictionary {
	 ...
	 * @return The byte representing the String s. If a unique byte cannot be returned for s then a RuntimeException is thrown (this is a coding error).
	 */
	public byte lookup(String s);

	/**
	 * @param code The byte code for a String.
	 * @return The String for the byte code. If a String is not stored for the byte code then a RuntimeException is thrown (this is a coding error).
	 */
